...
public class TagsStepsDefinition {
	...
	public void i_validate_the_outcomes1() {
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}
	...
	public void i_want_to_write_a_step_with_precondition3() {
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}

	@When("I complete action3")
	public void i_complete_action3() {
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}

	@Then("I validate the outcomes3")
	public void i_validate_the_outcomes3() {
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}
	...
	public void i_check_for_the(String string) {
		// Write code here that turns the phrase above into concrete actions
		//throw new io.cucumber.java.PendingException();
	}
